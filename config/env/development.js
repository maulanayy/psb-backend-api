...
module.exports = {
  ...
  datastores: {
    ...
    default: {
      ...
      url: "postgresql://postgres:admin@localhost:5432/psb_db",
      // url: `postgresql://stage:bismillah@/psbupistag?unix_socket=${encodeURIComponent(
      //   "/cloudsql/psbupi:asia-southeast2:psbupistag/psbupi"
      // )}`,
      // adapter: 'sails-mysql',
  ...
  session: {
     ...
     *                                                                          *
     ***************************************************************************/
    secret: "3574059e4702b62db7c77b038238be40",
    expired_date : "1 day",
    username : "admin@psbupi.com",
  ...
  assets : {
    dirImage : "/home/assetpsb/web/asset.psbfip.upi.edu/public_html/assets-media",
    dirHtml : "/home/developer/upload-stag/",
    urlHtml : "https://file-stg.psb.iqbalmuhyiddin.dev/",
    urlImage : "http://asset.psbfip.upi.edu/assets-media"
  }
};
